# Solve the Bertrand-Nash baseline equilibrium under a platform-monopolist
# counterfactual: only one platform survives (keep.platforms = c(1,0,0,0)),
# the other three are removed from the choice set entirely. Output:
# output/CF_feefirst/spec<nsim>/sub1000_baseline_<code>.rds, one per
