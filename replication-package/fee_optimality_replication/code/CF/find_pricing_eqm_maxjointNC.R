# Solve the joint-profit-maximising fees under no complementarity in
# restaurant adoption costs (maxjointNC). Output:
# output/CF_feefirst/spec<nsim>/maxjointNC_<code>_take2.rds, one per
